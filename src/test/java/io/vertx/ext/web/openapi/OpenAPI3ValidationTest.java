...
public class OpenAPI3ValidationTest {
  ...
  public void testDefaultIntQueryParameter() throws Exception {
    ...
    loadHandlers("/queryTests/defaultInt", HttpMethod.GET, false, validationHandler, (routingContext) -> {
      ...
      assertThat(requestParameter.isInteger()).isTrue();
  ...
  public void testDefaultFloatQueryParameter() throws Exception {
    ...
    loadHandlers("/queryTests/defaultFloat", HttpMethod.GET, false, validationHandler, (routingContext) -> {
      RequestParameters params = routingContext.get("parsedParameters");
      RequestParameter requestParameter = params.queryParameter("parameter");
      assertThat(requestParameter.isFloat()).isTrue();
      routingContext.response().setStatusMessage(requestParameter.toString()).end();
    });
  ...
  public void testDefaultDoubleQueryParameter() throws Exception {
    ...
    loadHandlers("/queryTests/defaultDouble", HttpMethod.GET, false, validationHandler, (routingContext) -> {
      RequestParameters params = routingContext.get("parsedParameters");
      RequestParameter requestParameter = params.queryParameter("parameter");
      assertThat(requestParameter.isDouble()).isTrue();
      routingContext.response().setStatusMessage(requestParameter.toString()).end();
    });
  ...
  public void testJsonBody() throws Exception {
    ...
    testRequestWithBufferResponse(HttpMethod.POST,
      ...
      object.toBuffer(), 200, "OK", "application/json", b -> assertThat(b.toJsonObject())).isEqualTo(object);
    testRequestWithBufferResponse(HttpMethod.POST,
      "/jsonBodyTest/sampleTest",
  ...
  public void testComplexMultipart() throws Exception {
    ...
    loadHandlers("/multipart/complex", HttpMethod.POST, false, validationHandler, (routingContext) -> {
      RequestParameters params = routingContext.get("parsedParameters");
      assertThat("sampleString").isEqualTo(params.formParameter("param1").getString());
      assertThat(params.formParameter("param2").getJsonObject()).isNotNull();
      assertThat("Willy").isEqualTo(params.formParameter("param2").getJsonObject().getString("name"));
      assertThat(4).isEqualTo(params.formParameter("param4").getArray().size());
  ...
  public void testEmptyParametersNotNull() throws Exception {
    ...
    loadHandlers("/pets", HttpMethod.POST, true, validationHandler, (routingContext) -> {
      RequestParameters params = routingContext.get("parsedParameters");
      assertThat(params.cookieParametersNames()).isEmpty(); //Here it should not throw exception (issue #850)
      assertThat(params.pathParametersNames()).isEmpty();
      assertThat(params.queryParametersNames()).isEmpty();
      assertThat(params.headerParametersNames()).isEmpty();
      assertThat(params.formParametersNames()).isEmpty();
      routingContext
        .response()
        .setStatusCode(200)
        .setStatusMessage("OK")
  ...
  public void testQueryExpandedObjectTestOnlyAdditionalProperties() throws Exception {
    ...
    loadHandlers("/queryTests/objectTests/onlyAdditionalProperties",
      ...
      (routingContext) -> {
        ...
        assertThat(param.getObjectKeys().contains("wellKnownParam")).isFalse();
  ...
  public void testCookieExpandedObjectTestOnlyAdditionalProperties() throws Exception {
    ...
    loadHandlers("/cookieTests/objectTests/onlyAdditionalProperties",
      ...
      (routingContext) -> {
        RequestParameters params = routingContext.get("parsedParameters");
        assertThat(params.cookieParameter("wellKnownParam").toString()).isEqualTo("hello");
  ...
  public void testQueryOptionalFormExplodeObject() throws Exception {
    ...
    loadHandlers("/query/form/explode/object", HttpMethod.GET, false, validationHandler, routingContext -> {
      ...
      assertThat(colorQueryParam).isNotNull();
      assertThat(colorQueryParam.isObject()).isTrue();
